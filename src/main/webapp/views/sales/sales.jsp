                            ...
                            <div class="flex flex-1 overflow-hidden">
                                ...
                                <aside
                                        ...
                                        <div class="flex items-center gap-2.5">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <div id="selectedCustomerName"
                                                    class="text-label-md text-on-surface truncate leading-tight">Khách
                                                    vãng lai</div>
                                                <div id="customerPointsDisplay"
                                                    class="text-caption text-primary hidden mt-0.5">
                                                    <span
                                                        class="material-symbols-outlined text-[12px] align-text-bottom">stars</span>
                                    ...
                                    <div class="flex-1 overflow-y-auto scrollbar-thin p-3 text-label-md">
                                        ...
                                        <div id="cartSummaryContent" class="min-h-full flex flex-col justify-between">
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <div class="flex justify-between">
                                                    ...
                                                    <span id="summaryDiscount" class="text-error font-semibold">0
                                                        ₫</span>
                                                </div>
                                                <div class="flex justify-between">
                                                    <span class="text-outline">Thuế (VAT
                                                        <fmt:formatNumber value="${vatPercentage}" type="number"
                                                            maxFractionDigits="1" />%)
                                                    </span>
                                                ...
                                                <div class="pt-2 border-t border-outline-variant">
                                                    ...
                                                    <div id="voucherMessage" class="hidden text-caption mt-1 px-6">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="pt-2 border-t border-outline-variant">
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        <span id="summaryTotal"
                                                            class="text-headline-lg text-primary font-bold leading-none">0
                                                            <span class="text-title-lg">₫</span></span>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="vnpayQRPanel"
                                            class="hidden flex flex-col items-center justify-center py-6 text-center">
                                            <div
                                                class="w-full max-w-[300px] bg-white rounded-2xl border border-outline-variant p-6 shadow-sm space-y-4">
                                                <div
                                                    class="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto">
                                                    <span
                                                        class="material-symbols-outlined text-[32px] text-primary">account_balance</span>
                                                </div>
                                                <div>
                                                    <p class="text-title-md font-bold">Thanh toán VNPAY</p>
                                                    <p class="text-caption text-outline mt-1">Mã đơn: <span
                                                            id="qrOrderCode"
                                                            class="text-primary font-semibold">...</span></p>
                                                </div>
                                                <button onclick="openVNPayWindow()"
                                                    class="w-full py-3 bg-primary text-white rounded-xl font-button-text hover:bg-secondary transition-colors flex items-center justify-center gap-2">
                                                    <span class="material-symbols-outlined">open_in_new</span> Mở VNPAY
                                                    thanh toán
                                                </button>
                                                <div id="qrStatusBadge"
                                                    class="flex items-center justify-center gap-2 py-2.5 px-4 bg-warning/10 rounded-xl text-sm text-warning font-semibold">
                                                    <div
                                                        class="w-4 h-4 border-2 border-warning border-t-transparent rounded-full animate-spin">
                                                    </div>
                                                    <span>Đang chờ thanh toán...</span>
                                                </div>
                                                <button onclick="cancelVNPayQR()"
                                                    class="text-sm text-outline hover:text-error transition-colors">Hủy
                                                    thanh toán</button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-surface-container-low border-t border-outline-variant p-3 space-y-2">
                                        ...
                                        <div class="flex gap-2">
                                            ...
                                            <button id="btnBank" onclick="selectPayMethod('BANK_TRANSFER')"
                                                ...
                                                <span
                                                    class="material-symbols-outlined text-[16px]">account_balance</span>
                                                VNPAY
                                            </button>
                                        </div>
                                        <!-- Checkout Button -->
                                ...
                                <div
                                    ...
                                    <button onclick="selectModalPayMethod('BANK_TRANSFER')" id="modalBtnBank"
                                        ...
                                        <div
                                            class="w-12 h-12 rounded-lg bg-surface-container-high flex items-center justify-center">
                                            <span
                                                class="material-symbols-outlined text-[28px] text-on-surface-variant">qr_code_scanner</span>
                                        </div>
                                        <div class="text-left">
                                            <div class="text-label-md font-bold">VNPAY</div>
                                            <div class="text-caption text-outline">Thanh toán qua VNPAY</div>
                                        </div>
                                    </button>
                                </div>
                                <!-- Right: Calculation -->
                                    ...
                                    <button onclick="pickCustomer(${c.cusId}, '${fn:escapeXml(c.fullName)}')"
                                        ...
                                        <div class="flex-1 text-left min-w-0">
                                            ...
                                            <div class="flex items-center gap-3 text-caption text-outline">
                                                ...
                                                <span class="flex items-center gap-1"><span
                                                        class="material-symbols-outlined text-[14px]">stars</span>${c.loyaltyPoint}
                                                    điểm</span>
                                            </div>
                                        </div>
                                        <span
