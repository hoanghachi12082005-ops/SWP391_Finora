...
<% request.setAttribute("pageTitle", "Store Manager / Search / Filter Store"); %>
<jsp:include page="/views/common/header.jsp" />
<jsp:include page="/views/common/sidebar.jsp" />
<main class="main">
    <div class="card">
        <h1>Store Manager / Search / Filter Store</h1>
        <p>Đây là trang JSP mẫu cho chức năng <strong>Store Manager / Search / Filter Store</strong>.</p>
