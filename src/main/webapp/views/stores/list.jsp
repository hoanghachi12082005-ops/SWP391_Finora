...
<% request.setAttribute("pageTitle", "Quản lý cửa hàng / Tìm kiếm / Lọc cửa hàng"); %>
<jsp:include page="/views/common/header.jsp" />
<jsp:include page="/views/common/sidebar.jsp" />
<main class="main">
    <div class="card">
        <h1>Quản lý cửa hàng / Tìm kiếm / Lọc cửa hàng</h1>
        <p>Đây là trang JSP mẫu cho chức năng <strong>Quản lý cửa hàng / Tìm kiếm / Lọc cửa hàng</strong>.</p>
