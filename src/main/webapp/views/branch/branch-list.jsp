            ...
            <div class="table-card">
                ...
                <div class="pagination">
                    ...
                    <c:if test="${currentPage > 1}">
                        <a href="branch?action=list&page=${currentPage - 1}&status=${selectedStatus}&city=${selectedCity}">
                            <<
                        </a>
                    </c:if>

                    <c:forEach begin="1" end="${totalPages}" var="i"> 
                        <a href="branch?action=list&page=${i}&status=${selectedStatus}&city=${selectedCity}"
