                                ...
                                <td>
                                    ...
                                    <td>
                                        <div class="action-group">
                                            <a class="btn-view"
                                               href="branch?action=detail&id=${b.branchId}&page=${currentPage}&sizeValue=${sizeValue}&keyword=${param.keyword}&status=${selectedStatus}&city=${selectedCity}">
                                               
                                               <i class="fa-regular fa-eye" style="color: rgb(24, 49, 83);"></i>
                                            </a>

                                            <a class="btn-edit"
                                               href="branch?action=edit&id=${b.branchId}&page=${currentPage}&sizeValue=${sizeValue}&keyword=${param.keyword}&status=${selectedStatus}&city=${selectedCity}">
