...
<% request.setAttribute("pageTitle", "Quản lý sản phẩm / Tìm kiếm / Lọc sản phẩm"); %>
<jsp:include page="/views/common/header.jsp" />
<jsp:include page="/views/common/sidebar.jsp" />
<main class="main">
    <div class="card">
        <h1>Quản lý sản phẩm / Tìm kiếm / Lọc sản phẩm</h1>
        <p>Đây là trang JSP mẫu cho chức năng <strong>Quản lý sản phẩm / Tìm kiếm / Lọc sản phẩm</strong>.</p>
