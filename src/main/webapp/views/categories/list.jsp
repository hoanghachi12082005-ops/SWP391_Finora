...
<% request.setAttribute("pageTitle", "Quản lý danh mục / Tìm kiếm / Lọc danh mục"); %>
<jsp:include page="/views/common/header.jsp" />
<jsp:include page="/views/common/sidebar.jsp" />
<main class="main">
    <div class="card">
        <h1>Quản lý danh mục / Tìm kiếm / Lọc danh mục</h1>
        <p>Đây là trang JSP mẫu cho chức năng <strong>Quản lý danh mục / Tìm kiếm / Lọc danh mục</strong>.</p>
