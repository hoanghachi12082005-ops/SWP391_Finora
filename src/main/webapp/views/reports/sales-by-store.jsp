...
<% request.setAttribute("pageTitle", "Báo cáo doanh số theo cửa hàng"); %>
<jsp:include page="/views/common/header.jsp" />
<jsp:include page="/views/common/sidebar.jsp" />
<main class="main">
    <div class="card">
        <h1>Báo cáo doanh số theo cửa hàng</h1>
        <p>Đây là trang JSP mẫu cho chức năng <strong>Báo cáo doanh số theo cửa hàng</strong>.</p>
