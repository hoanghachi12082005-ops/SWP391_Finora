...
<% request.setAttribute("pageTitle", "Sales Report by Store"); %>
<jsp:include page="/views/common/header.jsp" />
<jsp:include page="/views/common/sidebar.jsp" />
<main class="main">
    <div class="card">
        <h1>Sales Report by Store</h1>
        <p>Đây là trang JSP mẫu cho chức năng <strong>Sales Report by Store</strong>.</p>
