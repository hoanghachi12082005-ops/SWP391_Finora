...
<div class="toolbar" id="toolbar">
    ...
    <c:choose>
        ...
        <c:otherwise>
            <a class="btn-excel" href="${pageContext.request.contextPath}/reports/employee-sales-export-excel?keyword=${param.keyword}&branchId=${param.branchId}&dateFrom=${param.dateFrom}&dateTo=${param.dateTo}">
