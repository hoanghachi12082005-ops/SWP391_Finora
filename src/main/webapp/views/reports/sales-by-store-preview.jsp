...
<div class="toolbar" id="toolbar">
    ...
    <a class="btn-close" href="${pageContext.request.contextPath}/reports/sales-by-store?keyword=${param.keyword}&branchId=${param.branchId}&dateFrom=${param.dateFrom}&dateTo=${param.dateTo}">
        Đóng xem trước
    </a>
</div>
...
<div class="report-container">
    ...
    <c:if test="${not empty allReports}">
        <div class="report-header">
            <h1>Báo cáo doanh số theo chi nhánh</h1>
        ...
        <div class="summary-section">
            ...
            <div class="summary-grid">
                <span class="label">Tổng số chi nhánh</span>
                <span class="value">${reportOverview.totalBranches}</span>
                ...
                <c:if test="${not empty reportOverview.topBranchName}">
                    <span class="label">Chi nhánh xuất sắc nhất</span>
                    <span class="value">${reportOverview.topBranchName}</span>
                    <span class="label">Doanh thu cao nhất</span>
                    <span class="value"><fmt:formatNumber value="${reportOverview.topBranchRevenue}" type="number" groupingUsed="true"/> ₫</span>
                </c:if>
            </div>
        </div>
    </c:if>
