...
<% request.setAttribute("pageTitle", "Loyal Customer Ranking"); %>
<jsp:include page="/views/common/header.jsp" />
<jsp:include page="/views/common/sidebar.jsp" />
<main class="main">
    <div class="card">
        <h1>Loyal Customer Ranking</h1>
        <p>Đây là trang JSP mẫu cho chức năng <strong>Loyal Customer Ranking</strong>.</p>
