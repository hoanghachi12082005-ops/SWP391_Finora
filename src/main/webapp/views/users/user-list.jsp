                ...
                <section class="table-card">
                    ...
                    <div class="table-footer">
                        ...
                        <form method="get" action="${baseUrl}" class="pagination-info">
                            ...
                            <input type="hidden" name="roleId" value="${roleFilter == -1 ? '' : roleFilter}">
                        ...
                        <c:if test="${totalPages > 1}">
                            <div class="pagination">
                                ...
                                <c:if test="${currentPage > 1}">
                                    <a href="${baseUrl}?page=1&sizeValue=${sizeValue}&keyword=${keyword}&branchId=${branchFilter == -1 ? '' : branchFilter}&roleId=${roleFilter == -1 ? '' : roleFilter}&status=${statusFilter}">
                                        <<
                                    </a>
                                </c:if>
                                ...
                                <c:choose>
                                    <c:when test="${totalPages <= 5}">
                                        <c:forEach begin="1" end="${totalPages}" var="i">
                                            <a href="${baseUrl}?page=${i}&sizeValue=${sizeValue}&keyword=${keyword}&branchId=${branchFilter == -1 ? '' : branchFilter}&roleId=${roleFilter == -1 ? '' : roleFilter}&status=${statusFilter}"
                                    ...
                                    <c:otherwise>
                                        ...
                                        <a href="${baseUrl}?page=${totalPages}&sizeValue=${sizeValue}&keyword=${keyword}&branchId=${branchFilter == -1 ? '' : branchFilter}&roleId=${roleFilter == -1 ? '' : roleFilter}&status=${statusFilter}"
