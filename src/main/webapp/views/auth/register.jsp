        ...
        <div class="col-12 col-md-6 register-right">
            ...
            <div class="register-card">
                ...
                <div class="wizard-content active" id="step1">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="fullName" class="form-control custom-input">
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <select id="province" class="form-select custom-input">
                ...
                <div class="text-end">
                    ...
                    <button class="btn btn-finora" onclick="nextStep(2)">
                        Tiếp tục
                    </button>
            ...
            <div class="wizard-content" id="step3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="selectedIndustry" readonly class="form-control custom-input">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="shopName" class="form-control custom-input">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button class="btn btn-light" onclick="nextStep(2)">
                        Quay lại
                    </button>

                    <button class="btn btn-finora" onclick="submitRegister()">
                        Tạo cửa hàng
                    </button>
            ...
            <div class="wizard-content text-center"
                ...
                <button class="btn btn-finora w-100 mt-4">
                    Bắt đầu quản lý
                </button>
